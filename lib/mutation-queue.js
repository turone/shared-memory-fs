...
//
// This orders *mutations*; it deliberately does not make the allocator, the
// index or epoch publication concurrent — the kernel commits those one at a
// time (`#commit`), after preparation has run outside the lock.
