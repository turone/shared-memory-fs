...
`.` or `..` segment, NUL or a backslash is a `TypeError`; `mkdir`, `rm`
and `rename` also take a directory's trailing slash.
...
`recursive`; `unlink` of a directory is `EISDIR`. The place's own
...
| `EEXIST`  | `mkdir` of a virtual file, or of a directory without `recursive` (the place's own included)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| `EISDIR`  | `readFile` / `createReadStream` of an implicit directory; a virtual file written, copied or renamed where a directory is; a write or `unlink` of a place's own directory; `unlink` of a virtual directory                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
